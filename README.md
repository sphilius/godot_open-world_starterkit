...
| Checkpoints | `scripts/game/checkpoint_shrine.gd`, `scenes/landmarks/checkpoint_shrine.tscn` | Walking up to a shrine lights it (first visit), heals you to full and resets posture; its RespawnPoint becomes where you come back after dying. One stands before the courtyard, one on the sanctum causeway. The stone lantern stands in for the M2 shrine model |
